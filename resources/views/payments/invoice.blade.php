    ...
    <div class="box-container">
        ...
        <div class="transaction-box">
            ...
            <div class="item">
                ...
                <div class="value">{{ $fullPaymentInfo->employe->nom }} {{ $fullPaymentInfo->employe->prenom }} ({{ $fullPaymentInfo->employe->email }})</div>
            </div>
            <div class="item">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{{ $fullPaymentInfo->amount }} euros</td>
                            </tr>
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <div class="single_item">
                                        ...
                                        <span class="value">{{ $fullPaymentInfo->amount }} euros</span>
                                    </div>
                                    <div class="single_item">

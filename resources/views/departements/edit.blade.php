...
<div class="row g-4 settings-section">
    <div class="col-12 col-md-4">
        <h3 class="section-title">Editer un nouveau département</h3>
        <div class="section-intro">Editer votre département en remplissant le formulaire</div>
    </div>
            ...
            <div class="app-card-body">
                <form class="settings-form" method="POST" action="{{ route('departement.update', $departement->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-1" name="name" placeholder="Entrez le nom du département" value="{{ $departement->name }}" required>
                        @error('name')
